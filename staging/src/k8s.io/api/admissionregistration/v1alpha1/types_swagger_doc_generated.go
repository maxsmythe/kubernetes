...
var map_ValidatingAdmissionPolicySpec = map[string]string{
	...
	"matchConditions":  "MatchConditions is a list of conditions on the AdmissionRequest that must be met for a request to be validated. All conditions must be met for the request to be matched. An empty list of matchConditions matches all requests. If there is an error evaluating the condition, the error is ignored and the condition is considered matched.",
}
