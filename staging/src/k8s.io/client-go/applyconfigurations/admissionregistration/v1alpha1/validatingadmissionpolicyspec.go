...
func (b *ValidatingAdmissionPolicySpecApplyConfiguration) WithParamSource(value *ParamSourceApplyConfiguration) *ValidatingAdmissionPolicySpecApplyConfiguration {
	b.ParamSource = value
	return b
}
